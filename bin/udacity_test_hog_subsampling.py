...
mlDir = etcDir + '/ml_train_img'

dist_pickle = createClassifier(mlDir, color_space, spatial_size, hist_bins, orient, pix_per_cell, cell_per_block, hog_channel, spatial_feat, hist_feat, hog_feat)
svc = dist_pickle["clf"]
